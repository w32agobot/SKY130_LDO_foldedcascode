...
T {nf9 1x0.55/8} 670 -700 0 0 0.4 0.4 {}
N 220 -780 220 -760 {
lab=VDD}
N 220 -500 220 -480 {
lab=VSS}
...
C {devices/iopin.sym} 180 -260 0 1 {name=p1 lab=VSS}
...
C {sky130_fd_pr/nfet_01v8_lvt_nf.sym} 980 -340 0 0 {name=M6
L=4
W=1
nf=3
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt_nf.sym} 840 -340 0 1 {name=M7
L=4
W=1
nf=1
mult=1
